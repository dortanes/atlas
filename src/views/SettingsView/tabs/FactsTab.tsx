...
/**
 * FactsTab — view and manage per-persona facts in Settings.
 */
export default defineComponent({
  ...
  setup() {
    ...
    async function saveEdit() {
      ...
      await updateFact(editingId.value, editingText.value.trim())
  ...
  render() {
    return (
      <div class="settings-tab">
        <h3 class="settings-tab__title">Facts</h3>
        ...
        <div class="facts-add">
          <input
            class="settings-field__input facts-add__input"
            value={this.newFactText}
          ...
          />
          <button
            class="facts-add__btn"
            onClick={() => this.onAdd()}
            disabled={!this.newFactText.trim()}
          >
                  ...
                  <div key={f.id} class="facts-item">
                    {isEditing ? (
                      <div class="facts-item__edit">
                        <input
                          class="settings-field__input facts-item__edit-input"
